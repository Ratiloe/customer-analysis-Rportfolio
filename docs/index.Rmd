...
```
![profit_trends_across_the_year](../screenshots/profit_trends.png)
...
```
![monthly trends for each year](../screenshots/monthly_trends1.png)
...
salesData %>% 
  ...
  labs(y = "profits", x = "days(365)")

```
![scatter plot of the profits](../screenshots/scatter01.png)
